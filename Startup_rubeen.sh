...
<head>
    ...
    <title>Rubeen Perry | EC2 Static Site</title>
    <style>
        /* ===== GLOBAL STYLES ===== */
        * {
            margin: 0;
        ...
        body {
            ...
            line-height: 1.8;
            color: #f0f0f0;
            background-image: url(https://images.unsplash.com/photo-1768326543746-f76a7b48a633?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwxNzJ8fHxlbnwwfHx8fHw%3D);
...
<body>
    <div class="overlay">
        <div class="container">
            ...
            <header>
                <h1>Rubeen Perry</h1>
                <p>Cloud Engineer | Big Time Baller | Content Creator</p>
            </header>
            <!-- SECTION 1: ABOUT ME -->
            <section class="section">
                <h2>About Me</h2>
                <p>The 6'7 Big Time Baller Overseas Professional .</p>
            </section>
            <!-- EMBEDDED IMAGE -->
            <div class="image-container">
                <img src="https://images.unsplash.com/photo-1768310512589-5925669f1784?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwxNDF8fHxlbnwwfHx8fHw%3D">
                <p>Proper Preparation Prevent poor Performance</p>
            </div>
            ...
            <section class="section">
                <h2>Contact</h2>
                <p> Any issues email iamtheman@gmail.com</p>
            </section>
            <!-- FOOTER -->
            <footer>
                <p>&copy; 2026 EleMENTALS &mdash; There are no losses only lessons.</p>
            </footer>
        </div>
    </div>
</body>
