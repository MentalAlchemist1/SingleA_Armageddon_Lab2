...
<head>
    ...
    <title>Carl Cohen | EC2 Static Site</title>
    <style>
        /* ===== GLOBAL STYLES ===== */
        * {
            margin: 0;
        ...
        body {
            ...
            line-height: 1.8;
            color: #f0f0f0;
            background-image: url('https://images.unsplash.com/photo-1496715976403-7e36dc43f17b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8YmFja2dyb3VuZHxlbnwwfHwwfHx8MA%3D%3D');
...
<body>
    <div class="overlay">
        <div class="container">
            ...
            <header>
                <h1>Carl Cohen.</h1>
                <p>Cloud Engineer | Lifelong Learner</p>
            </header>

            <!-- SECTION 1: ABOUT ME -->
            <section class="section">
                <h2>About Me</h2>
                <p>An aspiring Cloud Engineer living and working remotely.</p>
            </section>

            <!-- EMBEDDED IMAGE -->
            <div class="image-container">
                <img src="https://images.unsplash.com/photo-1443428018053-13da55589fed?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fGxhcHRvcCUyMHdhbGxwYXBlcnxlbnwwfHwwfHx8MA%3D%3D">
                <p>The Remote Work Life</p>
            </div>
            ...
            <section class="section">
                <h2>Contact</h2>
                <p>Questions, collaborations, c.cohen971@gmail.com</p>
            </section>

            <!-- FOOTER -->
            <footer>
                <p>copy; 2026 EleMENTALS &mdash; I hate Keishias.</p>
            </footer>    
