...
<head>
    ...
    <title>Hasan Warren | EC2 Static Site</title>
    <style>
        /* ===== GLOBAL STYLES ===== */
        * {
            margin: 0;
        ...
        body {
            ...
            line-height: 1.8;
            color: #f0f0f0;
            background-image: url("https://plus.unsplash.com/premium_photo-1764687751941-8c3d13b33b19?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8ODBzJTIwTGFuc2NhcGV8ZW58MHx8MHx8fDA%3D");
...
<body>
    <div class="overlay">
        <div class="container">
            ...
            <header>
                <h1>Hasan Warren</h1>
                <p>Aspiring Cloud Engineer | Avid Chess Player | Workout Enthusiast</p>
            </header>

            <!-- SECTION 1: ABOUT ME -->
            <section class="section">
                <h2>About Me</h2>
                <p>The last of Generation-X that seeks to learn new things.</p>
            </section>

            <!-- EMBEDDED IMAGE -->
            <div class="image-container">
                <img src="https://plus.unsplash.com/premium_photo-1764691271600-2d169aa9acc4?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8ODBzJTIwTGFuZHNjYXBlfGVufDB8fDB8fHww">
                <p>Knowledge for knowledge's sake.</p>
            </div>
            ...
            <section class="section">
                <h2>Contact</h2>
                <p>Questions, collaborations, or inquiries? Send all inquires into the void email.</p>
            </section>

            <!-- FOOTER -->
            <footer>
                <p>&copy; 2026 EleMENTALS &mdash; Self control is strength.</p>
            </footer>
