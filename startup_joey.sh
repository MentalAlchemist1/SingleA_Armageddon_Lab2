...
<head>
    ...
    <title>Joey Jean Noel | EC2 Static Site</title>
    <style>
        /* ===== GLOBAL STYLES ===== */
        * {
            margin: 0;
        ...
        body {
            ...
            line-height: 1.8;
            color: #f0f0f0;
            background-image: url('https://images.unsplash.com/photo-1609864486219-2032ffac0643?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
...
<body>
    <div class="overlay">
        <div class="container">
            ...
            <!-- HEADER WITH NAME -->
            <header>
                <h1>Joey Jean Noel</h1>
                <p>Cloud Engineer | Protector | Wisdom | Lover | Respect</p>
            </header>

            <!-- SECTION 1: ABOUT ME -->
            <section class="section">
                <h2>About Me</h2>
                <p>What switch do you want to see?</p>
            </section>

            <!-- EMBEDDED IMAGE -->
            <div class="image-container">
                <img src="https://images.unsplash.com/photo-1518495973542-4542c06a5843?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" width="600" height="400" alt="Exploring New Horizons">
            ...
            <section class="section">
                <h2>Contact</h2>
                <p>For your inquiries please contact me via email at <a href="mailto:josephjeannoel@gmail.com">josephjeannoel@gmail.com</a></p>
            </section>
