...
<head>
    ...
    <title>Mark J. Holt | EC2 Static Site</title>
    <style>
        /* ===== GLOBAL STYLES ===== */
        * {
            margin: 0;
        ...
        body {
            ...
            line-height: 1.8;
            color: #f0f0f0;
            background-image: url('https://images.pexels.com/photos/8108625/pexels-photo-8108625.jpeg');
    ...
    <div class="overlay">
        <div class="container">
            ...
            <section class="section">
                <h2>About Me</h2>
                <p>A disciplined learner building strong foundations in code through repetition, precision, and real understanding.</p>
            </section>

            <!-- EMBEDDED IMAGE -->
            <div class="image-container">
                <img src="https://images.pexels.com/photos/29631731/pexels-photo-29631731.jpeg" alt="Code and Technology">
                <p>Building Through Discipline</p>
            </div>
            ...
            <section class="section">
                <h2>Contact</h2>
                <p>Questions, ideas, or collaboration? Contact me at <a href="mailto:aimarkjholt@gmail.com">aimarkjholt@gmail.com</a></p>
            </section>
