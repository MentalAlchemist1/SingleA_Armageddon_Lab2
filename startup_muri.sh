...
<head>
    ...
    <title>Muri Adegoke | EC2 Static Site</title>
    <style>
        /* ===== GLOBAL STYLES ===== */
        * {
            margin: 0;
        ...
        body {
            ...
            line-height: 1.8;
            color: #f0f0f0;
            background-image: url('https://plus.unsplash.com/premium_photo-1661883289130-2ef3b6612fb3?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
    ...
    <div class="overlay">
        <div class="container">
            ...
            <section class="section">
                <h2>About Me</h2>
                <p>A structural engineer who desires to be a cloud engineer.</p>
            </section>

            <!-- EMBEDDED IMAGE -->
            <div class="image-container">
                <img src="https://images.pexels.com/photos/1269968/pexels-photo-1269968.jpeg" alt="Engineering and Technology">
            ...
            <section class="section">
                <h2>Contact</h2>
                <p>Email: <a href="mailto:adedapo.adegoke@gmail.com">adedapo.adegoke@gmail.com</a></p>
            </section>
