...
<head>
    ...
    <title>William Steward | EC2 Static Site</title>
    <style>
        /* ===== GLOBAL STYLES ===== */
        * {
            margin: 0;
        ...
        body {
            ...
            line-height: 1.8;
            color: #f0f0f0;
            background-image: url(https://images.unsplash.com/photo-1564507004663-b6dfb3c824d5?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8bW9yb2Njb3xlbnwwfHwwfHx8MA%3D%3D);
...
<body>
    <div class="overlay">
        <div class="container">
            ...
            <!-- HEADER WITH NAME -->
            <header>
                <h1>William Steward</h1>
                <p>Electrician | Father | Entrepreneur</p>
            </header>

            <!-- SECTION 1: ABOUT ME -->
            <section class="section">
                <h2>About Me</h2>
                <p>A left-handed Millennial with mission to become my family's first millionaire</p>
            </section>

            <!-- EMBEDDED IMAGE -->
            <div class="image-container">
                <img src="https://images.unsplash.com/photo-1720718517204-a66cc17a1052?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTk4fHxtb3JvY2NvJTIwd29tZW58ZW58MHx8MHx8fDA%3D">
            ...
            <section class="section">
                <h2>Contact</h2>
                <p>For inquiries please contact me via email at wsteward3rd@gmail.com</p>
            </section>

            <!-- FOOTER -->
            <footer>
                <p>&copy; 2026 From Theo I Cometh &mdash; If we build, we become.</p>
            </footer>
